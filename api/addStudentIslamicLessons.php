...
if ($data != null) {
    ...
    $sql = "INSERT INTO IslamicLessonsStudent (firstName, surname, gender, ageGroup, dob, phone, email, country, package, amount) 
        VALUES ('$firstName', '$surname', '$gender', '$ageGroup', '$dob', '$phone', '$email', '$country', '$package', '$amount')";
